...
class DomainXML(object):
    ...
    def add_vlc_with_websockets(self):
        ...
        vlc_string_xml = (
            # don't use websockets, they are created externaly with websockify
            #f"    <graphics type='vnc' passwd='{passwd}' autoport='yes' websocket='-1' listen='0.0.0.0' > \n"
            f"    <graphics type='vnc' passwd='{passwd}' autoport='yes' listen='0.0.0.0' > \n"
...
def populate_dict_hardware_from_create_dict(id_domain):
    ...
    new_hardware_dict["graphics"] = id_graphics
...
#         log.error(
#             "{} not defined as id in graphics table, value default is used".format(id)
#         )
